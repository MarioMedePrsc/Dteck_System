                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('articulo-tipos.destroy',$articuloTipo->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('articulo-tipos.show',$articuloTipo->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('articulo-tipos.edit',$articuloTipo->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
